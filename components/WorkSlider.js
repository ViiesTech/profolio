              ...
              return (
                <div className='relative rounded-lg overflow-hidden flex item-center justify-center group' key={index}>
                  ...
                  <div className='flex items-center justify-center relative overflow-hidden '>
                    ...
                    group-hover:xl:-translate-y-20 duration-300  '>
                      <div className='flex item-center gap-x-2 text-[13px] tracking-[0.2em] '>
                        {/*title part 1*/}
                        <div className='delay-300'>Live</div>
                        {/*title part 2*/}
                        <div className='translate-y-[500%] group-hover:translate-y-0 translate-all  duration-300 delay-150' >Projects</div>
                        {/*icosn*/}
